...
class Dheera:
    ...
    धीर (Dheera) means "Courageous, Wise, Patient" in Sanskrit.
    ...
    def _init_tools(self):
        ...
        print(f"  ✓ Tools registered: {len(self.tools.list_tools())} available ({search_tools} search)")
...
if __name__ == "__main__":
    print("=" * 60)
    print("🧪 Testing Dheera with Web Search")
    print("=" * 60)
    ...
    for msg in test_messages:
        ...
        try:
            ...
            print(f"🤖 Dheera: {response_preview}")
